    ...
    options: [
      {
        ...
        color: '#d97706 hover:bg-amber-500',
      ...
      },
      {
        ...
        color: '#9333ea hover:bg-purple-500',
        action: { type: 'randomOutcome', outcomes: [
  ...
  // ============================================================
  {
    ...
    options: [
      ...
      },
      {
        label: '拒绝交易',
        sub: '安全离开，保存实力',
        color: 'bg-zinc-700 hover:#52525b',
    ...
    options: [
      {
        label: '饮用泉水',
        sub: '+40 HP，但最大生命永久 -5',
        color: '#059669 hover:bg-emerald-500',
        action: { type: 'randomOutcome', outcomes: [
      ...
      },
      {
        ...
        color: '#2563eb hover:bg-blue-500',
        action: { type: 'randomOutcome', outcomes: [
